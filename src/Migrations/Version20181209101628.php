...
final class Version20181209101628 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movies_director (movies_id INT NOT NULL, people_id INT NOT NULL, INDEX IDX_F6E47CC853F590A4 (movies_id), INDEX IDX_F6E47CC83147C936 (people_id), PRIMARY KEY(movies_id, people_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE movies_writer (movies_id INT NOT NULL, people_id INT NOT NULL, INDEX IDX_E0DC0A3653F590A4 (movies_id), INDEX IDX_E0DC0A363147C936 (people_id), PRIMARY KEY(movies_id, people_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE movies_actor (movies_id INT NOT NULL, people_id INT NOT NULL, INDEX IDX_3F9774F853F590A4 (movies_id), INDEX IDX_3F9774F83147C936 (people_id), PRIMARY KEY(movies_id, people_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE movies_director ADD CONSTRAINT FK_F6E47CC83147C936 FOREIGN KEY (people_id) REFERENCES people (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE movies_writer ADD CONSTRAINT FK_E0DC0A3653F590A4 FOREIGN KEY (movies_id) REFERENCES movies (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE movies_writer ADD CONSTRAINT FK_E0DC0A363147C936 FOREIGN KEY (people_id) REFERENCES people (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE movies_actor ADD CONSTRAINT FK_3F9774F83147C936 FOREIGN KEY (people_id) REFERENCES people (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE movies_writer');
