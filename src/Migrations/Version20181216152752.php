 ...
 */
final class Version20181216152752 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movies CHANGE user_id_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE movies ADD CONSTRAINT FK_C61EED30A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_C61EED30A76ED395 ON movies (user_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C61EED30A76ED395 ON movies');
        $this->addSql('ALTER TABLE movies CHANGE user_id user_id_id INT DEFAULT NULL');
